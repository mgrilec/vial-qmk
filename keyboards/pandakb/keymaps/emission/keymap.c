...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_split_3x6_3(
    ...
    KC_RALT,                KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM,     KC_DOT,  KC_SLSH, KC_RBRC,
                   LT(1, KC_BSPC), LSFT_T(KC_SPACE), LT(2, KC_ENTER),      LT(2, KC_ENTER), RSFT_T(KC_SPACE), LT(1, KC_DELETE)
  ),

  [1] = LAYOUT_split_3x6_3(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,        KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN,  KC_RPRN, KC_MINUS,
    KC_RALT, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,         KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_EQUAL,
                       KC_TRNS, KC_TRNS, LT(3, KC_ENTER),      LT(3, KC_ENTER), KC_TRNS, KC_TRNS
  ),

  [2] = LAYOUT_split_3x6_3(
     KC_GRV, KC_PSLS, KC_P7,   KC_P8,   KC_P9,   KC_PMNS,      KC_EQL,  KC_HOME, KC_UP,    KC_PGUP, KC_LPRN, KC_RPRN,
     _______,KC_PAST, KC_P4,   KC_P5,   KC_P6,   KC_PPLS,      KC_VOLU, KC_LEFT, KC_DOWN,  KC_RGHT, RALT(KC_F), RALT(KC_G),
     KC_NUM, KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PCMM,      KC_VOLD, KC_END,  KC_PSCR,  KC_PGDN, RALT(KC_B), RALT(KC_N),
